...
--Chinese
	[8] = {
		-- Options menu
		["options_description"] 				 = "FCO Lockpicker在你正在打开箱子时，藉由显示不同颜色的文字，来代表你剩余的开锁器数量。",
		["options_header1"] 			 		 = "一般设置",
		["options_language"] 					 = "语言",
		["options_language_tooltip"] 			 = "选择语言",
		["options_language_use_client"] 		 = "使用客户端的语言",
		["options_language_use_client_tooltip"]  = "让插件总是使用游戏客户端的语言。",
		["options_language_dropdown_selection1"] = "英文",
		...
		["options_normal_color_tooltip"] 		 = "如果你有足够的开锁器，则显示的'剩余的开锁器'的文字颜色。",
		["options_normal_value"] 				 = "正常门槛值",
		["options_normal_value_tooltip"] 		 = "对于'正常'颜色，你需要至少幾个解鎖器？",
		["options_medium_color"] 				 = "中 颜色",
		["options_medium_color_tooltip"] 		 = "如果你还有一些开锁器，则显示的'剩余的开锁器'的文字颜色。",
		["options_medium_value"] 				 = "中门槛值",
		["options_medium_value_tooltip"] 		 = "对于'中'颜色，你需要至少幾个解鎖器？",
		["options_low_color"] 					 = "低 颜色",
		["options_low_color_tooltip"] 			 = "如果你只剩下几个开锁器，则显示的'剩余的开锁器'的文字颜色。",
		["options_low_value"] 					 = "低门槛值",
		["options_low_value_tooltip"] 			 = "对于'低'颜色，你需要至少幾个解鎖器？",
		["options_header_chamber_resolved"] 	 = "房间已解锁",
		["options_show_chamber_resolved_icon"]	 = "显示膛室已解锁图标",
		["options_show_chamber_resolved_icon_tooltip"]	 = "如果當前的膛室的弹簧已达到解锁点，则显示一个图标。",
		["options_show_chamber_resolved_green_springs"]	= "显示绿色弹簧",
		["options_show_chamber_resolved_green_springs_tooltip"] = "如果膛室已解鎖，则将锁的弹簧着色為绿色。",
		--Chat commands
		["chatcommands_info"]					 = "|c00FF00FCO|cFFFF00Lockpicker|cFFFFFF",
		["chatcommands_help"]					 = "|cFFFFFF'help' / 'list'|cFFFF00: Shows this information about the addon",
		["chatcommands_debug"]					 = "|cFFFFFF'debug'|cFFFF00: Enable/Disable debug messages. |c990000[Attention]|cFFFF00 This will  flood your local chat!",
