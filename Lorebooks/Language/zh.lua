...
SafeAddString(LBOOKS_THANK_YOU1,					"谢谢你", 1)
SafeAddString(LBOOKS_THANK_YOU_LONG1,				"你是第一个找到这本丢失的书的人", 1)

SafeAddString(LBOOKS_THANK_YOU10,					"保持下去！", 1)
SafeAddString(LBOOKS_THANK_YOU_LONG10,				"那我们就可以收录所有的旧书籍", 1)

SafeAddString(LBOOKS_THANK_YOU20,					"图书管理员", 1)
SafeAddString(LBOOKS_THANK_YOU_LONG20,				"順道一提，你有读过那些书吗？你应该讀的", 1)
...
SafeAddString(LBOOKS_TITLE,							"典籍", 1)

--appearance
SafeAddString(LBOOKS_PIN_TEXTURE,					"选择地图图钉图标", 1)
SafeAddString(LBOOKS_PIN_TEXTURE_EIDETIC,			"选择地图图钉图标 (<<1>>)", 1)
SafeAddString(LBOOKS_PIN_TEXTURE_DESC,				"选择地图图钉图标。", 1)
SafeAddString(LBOOKS_PIN_TEXTURE_CHOICE1,			"Shalidor的图书馆图标" 1)
SafeAddString(LBOOKS_PIN_TEXTURE_CHOICE2,			"书籍图标设定1" 1)
SafeAddString(LBOOKS_PIN_TEXTURE_CHOICE3,			"书籍图标设定2" 1)
SafeAddString(LBOOKS_PIN_TEXTURE_CHOICE4,			"Esohead的图标 (Rushmik)" 1)
SafeAddString(LBOOKS_PIN_TEXTURE_EIDETIC_CHOICE1,	"永恒记忆图标" 1)
SafeAddString(LBOOKS_PIN_TEXTURE_EIDETIC_CHOICE2,	"书籍图标设定1" 1)
SafeAddString(LBOOKS_PIN_TEXTURE_EIDETIC_CHOICE3,	"书籍图标设定2" 1)
SafeAddString(LBOOKS_PIN_TEXTURE_EIDETIC_CHOICE4,	"Esohead的图标 (Rushmik)" 1)
...
--filters
SafeAddString(LBOOKS_UNKNOWN,						"显示未知的典籍", 1)
SafeAddString(LBOOKS_UNKNOWN_DESC,					"在地图上显示/隐藏未知的典籍的图标。", 1)
SafeAddString(LBOOKS_COLLECTED,						"显示已收集的典籍", 1)
...
SafeAddString(LBOOKS_EIDETIC_COLLECTED,				"显示已知的永恒记忆", 1)
...
--worldmap filters
SafeAddString(LBOOKS_FILTER_UNKNOWN,				"未知的典籍", 1)
SafeAddString(LBOOKS_FILTER_COLLECTED,				"收集的典籍", 1)
...
SafeAddString(LBOOKS_REPORT_BOOK,					"Report Book <<1>> ...", 1)
...
SafeAddString(LBOOKS_RE_ELIGIBLE,					"This book has been found in Horns of the Reach (Sept 2017) Eidetic Memory at this exact location. You can report it", 1)
...
-- Immersive Mode
SafeAddString(LBOOKS_IMMERSIVE,						"启用沉浸模式基于...", 1)
SafeAddString(LBOOKS_IMMERSIVE_DESC,				"根据你所查看的当前区域的以下任務的完成情况，将不会显示未知的典籍", 1)

SafeAddString(LBOOKS_IMMERSIVE_CHOICE1,				"禁用", 1)
SafeAddString(LBOOKS_IMMERSIVE_CHOICE2,				"区域主線任务", 1)
